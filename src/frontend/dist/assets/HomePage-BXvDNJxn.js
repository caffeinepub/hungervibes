import { r as reactExports, j as jsxRuntimeExports, u as useInternetIdentity } from "./index-CpqKU1zb.js";
...
function HomePage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "px-6 pt-10 pb-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-extrabold text-gray-900 tracking-tight", children: "HungerVibes" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-gray-500 text-base", children: "India's favourite food delivery platform" }),
          identity && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-green-600 font-medium", children: "✓ Signed in" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 px-4 pb-10 max-w-lg mx-auto w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-sm text-gray-500 mb-6 font-medium uppercase tracking-widest", children: "Select your panel" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-4", children: panels.map((panel, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.button,
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl", children: panel.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `font-bold text-lg ${panel.color}`, children: panel.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-gray-500 mt-0.5", children: panel.description })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 text-xl", children: "›" })
          ]
        },
        panel.id
      )) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "text-center py-4 text-xs text-gray-400", children: [
      "© ",
