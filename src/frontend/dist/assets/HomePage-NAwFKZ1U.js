import { r as reactExports, j as jsxRuntimeExports, u as useInternetIdentity } from "./index-BUhtkPfW.js";
...
function HomePage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "home-page min-h-screen flex flex-col overflow-hidden relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "home-bg", "aria-hidden": "true", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-hidden": "true", children: foodEmojis.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col items-center justify-center px-6 pb-24 relative z-10", children: [
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h1",
              {
                ...
                style: { color: "#1a1a1a" },
                children: "HungerVibes"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-500 mb-2 font-medium", children: "India's favourite food delivery platform" }),
            identity && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-green-600 font-semibold", children: "✓ Signed in" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.button,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative z-10 flex flex-col items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: "🛒" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-black tracking-tight", children: "Order Now" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium opacity-90", children: identity ? "Just logged in" : "Login or Sign Up" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "cta-shimmer", "aria-hidden": "true" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "bottom-bar", "aria-label": "Partner panels", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold", children: "Restaurant" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bottom-bar-divider", "aria-hidden": "true" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold", children: "Delivery Agent" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bottom-bar-divider", "aria-hidden": "true" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: "⚙️" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold", children: "Admin" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-20 w-full text-center text-xs text-gray-400 z-10", children: [
      "© ",
