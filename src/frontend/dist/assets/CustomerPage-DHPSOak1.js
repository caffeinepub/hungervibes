import { a as useActor, u as useInternetIdentity, r as reactExports, P as PaymentMethod, j as jsxRuntimeExports, B as Button } from "./index-CqKbeQm3.js";
import { c as createLucideIcon, C as Card, e as CardContent, L as LoaderCircle } from "./index-CtbFre5G.js";
...
function CustomerPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background pb-20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-52", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold truncate", children: _profile.name }),
    ...
    tab === "orders" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-4 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-sm text-muted-foreground", children: "Your Orders" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", onClick: loadOrders, children: "Refresh" })
      ] }),
        ...
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
            ...
            !["cancelled", "rejected", "delivered"].includes(
              o.status
            ) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 items-center", children: [
              "pending",
              "accepted",
              "preparing",
              "ready_for_pickup",
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `flex-1 h-1.5 rounded-full ${stepIdx <= currentIdx ? "bg-primary" : "bg-muted"}`
                },
                step
              );
            }) }) }),
