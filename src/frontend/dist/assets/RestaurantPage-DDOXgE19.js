import { a as useActor, r as reactExports, j as jsxRuntimeExports, B as Button, O as OrderStatus, E as ExternalBlob } from "./index-CqKbeQm3.js";
import { c as createLucideIcon, L as LoaderCircle, C as Card, a as CardHeader, b as CardTitle, e as CardContent } from "./index-CtbFre5G.js";
import { D as DropdownMenu, a as DropdownMenuTrigger, U as User, C as ChevronDown, b as DropdownMenuContent, c as DropdownMenuSeparator, d as DropdownMenuItem } from "./dropdown-menu-DTpGRL4L.js";
import { I as Input } from "./input-e40uH6z2.js";
import { L as Label } from "./label-BRJHjl11.js";
import { L as LogOut } from "./log-out-Clg8hOV2.js";
import { S as Store } from "./store-IzBCY3uB.js";
/**
...
function RestaurantPage({
  ...
  const [assigningOrder, setAssigningOrder] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    ...
    actor.getVerifiedDeliveryAgents().then(setAgents).catch(() => {
    });
  }, [actor]);
  ...
  async function assignAgent(orderId) {
    ...
    try {
      await actor.restaurantAssignAgent(orderId, agentPrincipal);
      loadOrders(restaurant.id);
      actor.getVerifiedDeliveryAgents().then(setAgents).catch(() => {
      });
    } finally {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-full bg-primary-foreground/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 16 }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-52", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold truncate", children: profile.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Restaurant Partner" })
          ] }),
    ...
    tab === "orders" && restaurant && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-4 space-y-3", children: orders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      Card,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
          ...
          o.status === "pending" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                size: "sm",
          ...
          o.status === "ready_for_pickup" && !o.deliveryAgentId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-medium text-purple-700 bg-purple-50 px-2 py-1 rounded", children: "🔍 Assign a delivery agent" }),
            agents.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "No verified agents available right now." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  ...
                  children: [
                    ...
                    agents.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "option",
                      {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  disabled: !selectedAgent[String(o.id)] || assigningOrder === o.id,
                  onClick: () => assignAgent(o.id),
                  children: assigningOrder === o.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "animate-spin", size: 14 }) : "Assign"
                }
              )
            ] })
          ] }),
          o.status === "ready_for_pickup" && o.deliveryAgentId && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-xs bg-indigo-50 text-indigo-700 px-2 py-1 rounded", children: "⏳ Waiting for agent to accept the assignment..." }),
          o.status === "picked_up" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-xs bg-green-50 text-green-700 px-2 py-1 rounded", children: "🛵 Agent has picked up the order — on the way!" })
        ] })
      },
      String(o.id)
    )) }),
