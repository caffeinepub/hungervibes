import { c as createLucideIcon, a as useActor, u as useInternetIdentity, r as reactExports, j as jsxRuntimeExports, L as LoaderCircle, O as OrderStatus } from "./index-CpqKU1zb.js";
import { B as Button, C as Card, d as CardContent } from "./card-BCEnsvtS.js";
...
function DeliveryPage({
  ...
  if (!profile.isVerified) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col items-center justify-center px-4 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold mb-2", children: "Verification Pending" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Your account is being verified by an admin. You'll be able to accept deliveries once approved." })
    ] });
  }
