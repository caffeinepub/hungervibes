import { r as reactExports, j as jsxRuntimeExports } from "./index-BegdjZEk.js";
...
function HomePage({
  ...
  function handleCardClick(panel) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        background: "linear-gradient(150deg, #fff7ed 0%, #ffffff 40%, #fff1f2 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "w-full pt-10 pb-4 flex flex-col items-center gap-2 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-gray-500 font-medium", children: "India's favourite food delivery platform" })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col items-center justify-center px-4 sm:px-8 py-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.p,
            {
              initial: { opacity: 0 },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-5 w-full max-w-2xl", children: ROLE_CARDS.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.button,
            {
              type: "button",
              "data-ocid": card.ocid,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold text-gray-900", children: card.title })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 flex-1 leading-relaxed", children: card.subtitle }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mt-4 text-sm font-semibold text-gray-700 group-hover:text-orange-600 transition-colors", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "w-full text-center py-5 text-xs text-gray-400", children: [
          "© ",
