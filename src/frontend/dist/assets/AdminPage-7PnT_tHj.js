import { a as useActor, r as reactExports, j as jsxRuntimeExports, R as Role, b as ue } from "./index-DV-6S0ca.js";
import { c as createLucideIcon, B as Button, C as Card, e as CardContent, a as CardHeader, b as CardTitle, L as LoaderCircle } from "./card-i9dVXPVy.js";
import { I as Input } from "./input-Bhw0c9RP.js";
import { L as Label } from "./label-BpS8ZuHQ.js";
import { S as Skeleton } from "./skeleton-Czy5JEQh.js";
import { H as House, L as LogOut } from "./log-out-Ct-Nwkge.js";
import { P as Package } from "./package-BChjr8f3.js";
import { S as Store } from "./store-CqhcuXdh.js";
/**
...
function AdminPage({
  ...
  const [verifiedAgentInfos, setVerifiedAgentInfos] = reactExports.useState([]);
  ...
  async function loadAll(isRefresh = false) {
    ...
    try {
      const [rests, allOrders, cust, ag, own, rev, anal, verifiedAg] = await Promise.all([
  ...
  async function approveRest(id) {
    ...
    ue.success("Restaurant approved");
    loadAll(true);
  }
  async function rejectRest(id) {
    await (actor == null ? void 0 : actor.rejectRestaurant(id));
    ue.error("Restaurant rejected");
    loadAll(true);
  }
  async function suspendRest(id) {
    await (actor == null ? void 0 : actor.suspendRestaurant(id));
    ue.success("Restaurant suspended");
    loadAll(true);
  }
  async function suspendAgent(principal) {
    await (actor == null ? void 0 : actor.suspendUser(principal));
    ue.success("Agent suspended");
    loadAll(true);
  }
  ...
  agents.filter((u) => u.isVerified && !u.isSuspended);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-primary text-primary-foreground px-4 py-3 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-bold shrink-0", children: "🔥 Admin" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
          navItems.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        tab === "users" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            ...
            pendingAgents.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border-2 border-orange-400 bg-orange-50 p-4 space-y-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-orange-700", children: "These agents registered and are awaiting your verification." }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-orange-600 mt-1", children: "ℹ️ To verify pending agents, ask them to log in — after successful identity setup they appear in Verified list." })
            ] }),
            verifiedAgentInfos.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-semibold text-green-700 uppercase tracking-wide", children: [
                "Verified Agents (",
                verifiedAgentInfos.length,
                ")"
              ] }),
              verifiedAgentInfos.map((a, vIdx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Card,
                {
                  "data-ocid": `admin.agent.item.${vIdx + 1}`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-3 flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-sm", children: a.name }),
            ...
            suspendedAgents.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              ...
              suspendedAgents.map((u, sIdx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Card,
                {
